...
public class Panel extends JFrame {
	...
	public Panel() {
		...
		temp = new ChessPiece("temp",Color.blue,30,30,gamePanel);
		...
		rg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (temp != null && (temp.getName().equals("blueTriangle") || 
					...
					ChessPiece pieceRemoved = gamePanel.getPoint(m, n).getPiece();
					gamePanel.getPoint(m, n).reMovePiece(pieceRemoved, gamePanel);
					type++;
					if(type%4 == 1) {
						temp = new ChessBlueTriangle2("blueTriangle2", Color.blue, 30, 30, gamePanel);
					} else if(type%4 == 2) {
						temp = new ChessBlueTriangle3("blueTriangle3", Color.blue, 30, 30, gamePanel);
					} else if(type%4 == 3) {
						temp = new ChessBlueTriangle4("blueTriangle4", Color.blue, 30, 30, gamePanel);
					} else if(type%4 == 0) {
						temp = new ChessBlueTriangle("blueTriangle", Color.blue, 30, 30, gamePanel);
					}
