...
public class MagicKeyListener implements KeyListener {
	 ...
	 * 
	 * @effects creates a new MagicKeyListener without the generation of additional
	 *          key release events (the third option given in the class overview is
	 *          disabled).
	 */
	 ...
	 *            enables the third option listed in the class overview, namely that
	 *            any key release event implies that all keys have been released.
	 *
	...
	/**
	 * @returns an immutable object which is representative of the key associated
	...
	/**
	 * @returns an event which is constructed from the given immutable key (from the
	 *          marker method) and a template event.
	 */
	...
	/**
	 * A simple class which forms a closure around a key typed event. When run, it
	 * fires the event to the keyTyped method of the adaptee.
	 */
	...
	/**
	 * A simple class which forms a closure around an key pressed event. When run,
	 * it fires the event to the keyPressed method of the adaptee only if the
	 * pressed keyset still contains this key and the adaptee has not already been
	 * informed.
	 */
	...
	/**
	 * A simple class which forms a closure around an key released event. When run,
	 * it fires the event to the keyReleased method of the adaptee only if the
	 * pressed keyset does not contains this key and the adaptee has not already
	 * been informed of the release.
	 */
